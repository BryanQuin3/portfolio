...
export const ProjectCard = ({ project }) => {
  ...
  return (
    <article
      ref={cardRef}
      className={`opacity-0 flex items-center flex-col justify-center gap-4 p-8 h-full  rounded-xl bg-gradient-to-r from-gray-100 via-green-50 to-amber-50 border  hover:shadow-sm`}
    >
